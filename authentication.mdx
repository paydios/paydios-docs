---
title: "Paydios API Authentication: Bearer Tokens and SDK Auth"
sidebarTitle: "Authentication"
description: "Paydios authenticates every API request with Bearer token API keys. Learn how to pass keys securely, use the PHP SDK auto-auth, and handle auth errors."
---
...
Log in to the merchant dashboard and navigate to **Dashboard → API Keys** at [merchant.paydios.io/dashboard/api-keys](https://merchant.paydios.io/dashboard/api-keys). You will find two types of credential:
...
$pk = new Client(); // auto-reads PAYDIOS_SECRET_KEY from env
```
...
- **Rotate your secret key immediately** if you suspect it has been compromised. Generate a new key in the dashboard at [merchant.paydios.io/dashboard/api-keys](https://merchant.paydios.io/dashboard/api-keys) and update all server environments.
